...
var FileHelper = (function () {
    ...
    ;
    FileHelper.createRoutingModule = function (componentDir, componentName, config) {
        var templateFileName = this.assetRootDir + '/templates/routing-module.template';
        if (config.template) {
            templateFileName = this.resolveWorkspaceRoot(config.template);
        }
        ...
        var filename = componentDir + "/" + componentName + "routing.module." + config.extension;
    ...
    FileHelper.createCss = function (componentDir, componentName, config) {
        var templateFileName = this.assetRootDir + '/templates/scss.template';
        if (config.template) {
            templateFileName = this.resolveWorkspaceRoot(config.template);
        }
